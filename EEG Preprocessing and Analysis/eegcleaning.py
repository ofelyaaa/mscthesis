...
# CONFIG
p_num = 18 #participant number here
base_data_path = '/Users/ofelyaaliyeva/Desktop/MSc_Thesis/EEGData'
locs_path = '/Users/ofelyaaliyeva/Desktop/MSc/EEG/eeglab2024.0/sample_locs/Standard-10-20-Cap81.locs'
...
# If the printout above for raw_ica.annotations is empty, the annotations were lost.
# Let's plot the data that ICA will see to visually confirm.
...
# The list of candidates to auto-plot is now just from EOG and Heartbeat.
# You can use the ICLabel list above to guide your manual inspection.
all_candidates = sorted(set(eog_inds).union(heartbeat_candidates))

# 6. VISUALIZATION
# 6. VISUALIZATION AND INSPECTION ### NEW/MODIFIED SECTION ###
