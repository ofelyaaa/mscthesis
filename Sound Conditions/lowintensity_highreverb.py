...
# --- Normalize to target RMS (e.g., 0.00056 ≈ 35 dB SPL)
def normalize_rms(signal_array, target_rms=0.00056):
...
processed = normalize_rms(processed, target_rms=0.00056)
...
print(f"Approx dB SPL: {db + 100:.1f} dB")  # Should be close to 35 dB
...
sf.write("lowintensity_highreverb.wav", processed_int16, sample_rate)
